...
//Left Motors:
motor_group(fLeftMotor, mLeftMotor, bLeftMotor),
 
//Right Motors:
motor_group(fRightMotor, mRightMotor, bRightMotor),
...
void pre_auton(void) {
  ...
  vexcodeInit();
  fLeftMotor.setStopping(brake);
  mLeftMotor.setStopping(brake);
  bLeftMotor.setStopping(brake);
  fRightMotor.setStopping(brake);
  mRightMotor.setStopping(brake);
  bRightMotor.setStopping(brake);
...
void usercontrol(void) {
  // User control code here, inside the loop
     Controller1.ButtonL2.pressed(ButtonL2_Callback);
 
    Controller1.ButtonR2.pressed(ButtonR2_Callback);
